...
(function( $, undefined ) {
	console.log("DICKHEAD MOTHERFUCKER");
		...
		$.extend( widget, {
			...
			close: function() {
				...
				if ( self.menuType == "page" ) {
					...
					console.log("back fired menuTyp=page");
					window.history.back();
				} else {
					console.log("regular, add ui-screen-hidden to screen, ui-selectmenu-hidden to listbox, remove 'style' and 'in' ");
