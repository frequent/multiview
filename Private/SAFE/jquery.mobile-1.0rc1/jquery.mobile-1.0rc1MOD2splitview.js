...
/* Event Bindings - hashchange, submit, and click */
	...
	$.mobile._registerInternalEvents = function(){ 
        ...
        $("form").live('submit', function(event){
          ...
          // TODO [Asyraf] temporarily put this here eventually should just set it immediately instead of an interim var.
          ...
          var transition = $link.jqmData( "transition" ),
			...
			if ($targetPanel) { 
				...
				var isRefresh=$link.jqmData('refresh'),				
					...
					$currPanelActivePage=$currPanel.children('div.'+$.mobile.activePageClass),
					url=path.stripHash($link.attr("href")),
					from = undefined,
				...
				if ($targetPanelActivePage.attr('data-url') == url || $currPanelActivePage.attr('data-url') == url) {				
					...
					// regular JQM - navigating between pages!					
						...
						if ( $last0 == "yield" )  { 
							for (i = longestLen-2; i>=0; i--) {				
								...
								for (i = longestLen-2; i>=0; i--) {
									...
									// fullwidth/popover (popover always goes first until in basic mode)
...
$.mobile.fixedToolbars = (function() {
	...
	var stickyFooter, delayTimer,
		...
		/* XXX FREQUENT - new selector includes all relevant elements - two general selectors would be nice... ala ui-fixed-top & ui-fixed-bottom */				
