	...
	$.widget("mobile.multiview",$.mobile.widget, {
		...
		_setupPopovers: function() {
			...
			function hideAllPanels () {
				...
				$('.ui-fullscreen-mode div:jqmData(panel="main") .ui-page-active div:jqmData(role="header")').attr('data-position','fixed')
			...
			$('.toggle_popover').live('click', function(event) {
				...
				$('.ui-fullscreen-mode div:jqmData(panel="main") .ui-page-active div:jqmData(role="header")').removeAttr('data-position')
		...
		heightened: function ($thisPage) {
				...
				// TODO nont nice... find solution for menu and main panel, with only main having a "global footer"				
		...
		_mainEventBindings: function () {
			...
			// panel history 
			// TODO: listening to live/pageshow on nested pages does not work. pagecreate fires too often, 
			// this is ok, but not perfect			
