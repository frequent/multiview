...
// TODOS:		
		...
		// 2476 from.data("page" undefined, if page2 (crisscross)>page1>page3
...
(function( $, window) {	
	...
	$.widget("mobile.multiview",$.mobile.widget, {
		...
		checkWidth: function( fromWhere ) {					
			...
			if (self.framer() != 'small' && $('html').hasClass('ui-splitview-mode') && $('div:jqmData(panel="menu")').outerWidth() == 250 ) {
				
				var $width = window.innerWidth,					
					$menuWidth = $('div:jqmData(panel="menu")').outerWidth();
				console.log($width-$menuWidth)
				$('div:jqmData(panel="main")').css({'margin-left':'250px','width':$width-$menuWidth});
		...
		panelHeight: function (page) {
			...
			/* OK *//*	
				...
				$('div:jqmData(role="panel")').not('.ui-popover').css({'min-height': $.mobile.getScreenHeight()-$globalHeader-$globalFooter})							
				*/
			},
