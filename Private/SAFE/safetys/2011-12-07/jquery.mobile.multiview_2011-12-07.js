...
// TODOS:		
		...
		// README - adjust padding for global header/footer, adjust backbutton for global header/footer
...
(function( $, window) {	
	...
	$.widget("mobile.multiview",$.mobile.widget, {
		...
		_create: function() {		
			...
			console.log( "jqmStackInit - set to: "+	self.options.$jqmHistoryStackAtInit);		
		...
		crumble: function(event, data, page) {			
			  ...
			  function crumbify(button, href, text, page, header){				 				
					...
					if(!button.length || button.hasClass('ui-crumbs') == true ) {
							...
							// clear old button
							button.closest('div:jqmData(wrapper="true").ui-page-active').find('.ui-global-header .ui-crumbs').andSelf().remove();
