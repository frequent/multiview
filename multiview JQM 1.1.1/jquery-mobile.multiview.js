/*
* jQuery Mobile Framework Git Build: SHA1: 68030a8b8c03dd3ddb29fc63c2eaad88df6aec0d <> Date: Mon Jun 4 23:11:56 2012 +0300
...
$.widget( "mobile.collapsibleset", $.mobile.widget, {
	...
	_create: function() {
		var $el = this.element.addClass( "ui-collapsible-set" ),
			// XXX FRE - add direction and corner classes
			o = $.extend({ direction: $el.jqmData("type") || "" }, this.options ),
			toggleCorners = o.direction == "horizontal" ? [ "ui-corner-bl ", "ui-corner-br "] : ["ui-corner-bottom ","ui-corner-bottom " ];
		
		// XXX FRE - add horizontal class 
		if ( o.direction == "horizontal" ) {
			$el.closest( ":jqmData(role='collapsible-set')" ).addClass("ui-collapsible-set-horizontal").grid({ grid: this.options.grid });
		}	
		// Inherit the theme from collapsible-set
		if ( !o.theme ) {
			o.theme = $.mobile.getInheritedTheme( $el, "c" );
			...
			$el
				...
				.bind( "expand collapse", function( event ) {
					var isCollapse = ( event.type === "collapse" ),
						...
						index = $el.closest('.ui-collapsible-set').find('.ui-collapsible').index( collapsible )
					
					if ( contentTheme && ( index == 0 || collapsible.jqmData( "collapsible-last" ) ) ) {
						collapsible.find( widget.options.heading ).first()
							.find( "a" ).first()
							.toggleClass( toggleCorners[ index == 0 ? 0 : 1], isCollapse )
							.find( ".ui-btn-inner" )
							.toggleClass( toggleCorners[ index == 0 ? 0 : 1], isCollapse );
	...
	refresh: function() {
		var $el = this.element,
			o = $.extend({ direction: $el.jqmData("type") || "" }, this.options ),
			collapsiblesInSet = $el.children( ":jqmData(role='collapsible')" ),
			baseCorners = o.direction == "horizontal" ? [ "ui-corner-tl ", "ui-corner-tr " ] : ["ui-corner-top ", "ui-corner-bottom "];

		$.mobile.collapsible.prototype.enhance( collapsiblesInSet.not( ".ui-collapsible" ) );
		
		// clean up borders
		collapsiblesInSet.each( function(i) {
		...
		collapsiblesInSet.first()
			.find( "a" )
				.first()
				.addClass( o.direction ? "ui-corner-tl ui-corner-bl" : "ui-corner-top " )
				.find( ".ui-btn-inner" )
					.addClass( o.direction ? "ui-corner-tl ui-corner-bl" : "ui-corner-top " );
		...
		collapsiblesInSet.last()
			...
			.find( "a" )
				.first()
				.addClass( o.direction ? "ui-corner-tr ui-corner-br" : "ui-corner-bottom ")
				.find( ".ui-btn-inner" )
					.addClass( o.direction ? "ui-corner-tr ui-corner-br" : "ui-corner-bottom " );
	}			
});
